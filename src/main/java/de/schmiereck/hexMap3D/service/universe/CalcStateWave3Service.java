...
/**
 * {@link de.schmiereck.hexMap3D.service.Engine.EngineWaveType#WaveDividerClassicMove}
 */
public class CalcStateWave3Service {
        ...
        for (final Cell.Dir calcDir : Cell.Dir.values()) {
            ...
            sourceCellState.getWaveListStream()
                    ...
                    .forEach((sourceWave) -> {
                        ...
                        // HasWaveOutput in this direction?
                        if (checkSourceWaveHasWaveOutput(sourceWave, oppositeCalcDir)) {
                            // Than divide.
                            final int sourceWaveProb = MapMathUtils.divide(sourceWave.getWaveProb(), 2,
                                    false);
                            if (sourceWaveProb > 0) {
